---
id: orchestral-suites
type: work
bwv: "1066–1069"
title: "The Four Orchestral Suites (Ouvertüren)"
genre: orchestral
key: "C, b, D, D"
forces: "Various — from strings-and-oboes to full trumpets-and-drums festival band"
era: leipzig-2
place: leipzig
date_composed: 1730
date_precision: circa
dating_note: "Long assumed Cöthen works; surviving sources are Leipzig (Collegium era, c. 1725–39), and modern scholarship dates much of the music there — No. 2 likely latest (c. 1738–39)."
occasion: "Collegium Musicum (as transmitted)"
tier: set
set: ""
provenance: disputed
craft_tags: [french-overture, dance-suite]
recording:
...
**What it is.** Four *Ouvertüren* — the French genre ([Celle's legacy](../../events/lueneburg/hamburg-celle-trips.md)): a grand dotted overture, then a chain of dances — at four different orchestral weights, from the B-minor's chamber intimacy (solo flute and strings) to the D-major pair's trumpets-and-drums civic blaze.
