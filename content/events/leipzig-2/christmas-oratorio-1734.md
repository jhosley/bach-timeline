...
date_precision: day
tracks: [works, craft]
title: "Christmas 1734: the Oratorio, and the parody workshop at full power"
place: leipzig
provenance: documented
people: [picander]
related_events: [cantata-machine, clavier-ubung]
sources:
  - "Original performing materials of BWV 248 (Bach Digital)"
  - "Dürr, The Cantatas of J. S. Bach"
summary: >
  Six cantatas spanning Christmas Day to Epiphany — much of the music re-texted from recent
  secular court cantatas — form the Christmas Oratorio: the definitive exhibit of Bach's
  parody technique.
---
...
For the study of Bach's craft, comparing the paired versions (both survive) is uniquely instructive: watch what he adjusts — declamation re-fitted syllable by syllable, affect re-aimed, instrumentation retouched — and what he doesn't, and you learn precisely what he considered a movement's *substance* versus its clothing.

**Why it matters.** The definitive answer to the parody "scandal": recycling was not fatigue but **architecture in time** — and the Oratorio's afterlife doubles the lesson, since this most-beloved of Bach's festive works spent a century forgotten with the rest of the vocal music (first revived, fittingly, [in 1857 Berlin](../../eras/revival.md)). The R3 card will map every borrowing movement by movement.
